            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Lottie.asset('animations/38435-register.json',
                        ...
                        reverse: true,
                        fit: BoxFit.cover),
                    Text('Syed Muhaymin Hassan Naqvi',style: TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                      fontWeight: FontWeight.bold
                    ),),
                    SizedBox(height: 10,),
                    Text('muhayminhassan930@gmail.com',style: TextStyle(
                      color: Colors.white,
                      fontSize: 11,
                    ),),
                    SizedBox(height: 10,),
              ...
              GestureDetector(
                  onTap: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  ItemCategoriesListView()),
                    );
                  },
              ...
              GestureDetector(
                  onTap: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  PurchaseOrderListView()),
                    );
                  },
              ...
              GestureDetector(
                  onTap: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  PurchaseOrderItemListView()),
                    );
                  },
              ...
              child: Container(height: 60,width: double.infinity,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(children: [
                        Icon(Icons.location_on_sharp,color: Colors.red,size: 17,),
                        Text('Head Of Computer Science Department',style: TextStyle(
                          fontWeight: FontWeight.bold
                        ),)
                      ],),
                      SizedBox(height: 3,),
                          ...
                          Row(children: [
                            GestureDetector(
                                onTap: (){
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) =>  DetailOrderListView()),
                                  );
                                },
                                child: IconContainer(iconname: Icons.home,title: 'Home', colorbox: Colors.red,)),
                            Spacer(),
                            GestureDetector(
                                onTap: (){
                                  Navigator.push(
                                ...
                                child: IconContainer(iconname: Icons.access_alarm,title: 'Home', colorbox: Colors.yellow,)),
                            Spacer(),
                            GestureDetector(
                                onTap: (){
                                  Navigator.push(
                                ...
                                child: IconContainer(iconname: Icons.accessibility_new_outlined,title: 'Home', colorbox: Colors.green,)),
                          ],)
                        ],
                      ),
                    ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 18,),
                    Text('Inventory',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                  ],
                ),)
              ],
            ),
